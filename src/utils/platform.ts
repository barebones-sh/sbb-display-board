 ...
 * boarding-sector suffix baked in (verified live: "7A-D"). The reference
 * images show the sector as a small secondary badge next to the main track
 * number (e.g. Bern's "13 AB"), so split it back out here.
 */
